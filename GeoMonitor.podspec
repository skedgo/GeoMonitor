#
#  Be sure to run `pod spec lint GeoMonitor.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://developer.tripgo.com"
  ...
  spec.author             = { "Adrian Schoenig" => "adrian@skedgo.com" }
  ...
  spec.source       = { :git => "https://github.com/skedgo/GeoMonitor.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Sources/GeoMonitor"
